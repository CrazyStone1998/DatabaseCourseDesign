"""
Django settings for DatabaseCourseDesign project.
...
SECRET_KEY = 'xge=xqxa)ttc=86-5)7q#f)v85$$ba-3gtk(x^4wjxow64wg3i'
...
WSGI_APPLICATION = 'DatabaseCourseDesign.wsgi.application'
